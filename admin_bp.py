...
def update_crypto_qr():
    ...
    # 🔹 NEW — Withdraw Crypto (payout) fields
    _maybe_set(s, "withdraw_crypto_address",
               (request.form.get("withdraw_crypto_address") or "").strip())
...
def update_chime_qr():
    ...
    # 🔹 NEW — Withdraw Chime (payout) fields
    _maybe_set(s, "withdraw_chime_handle",
               (request.form.get("withdraw_chime_handle") or "").strip())
