...
# =============================================================================
# Flask app context helper (so Celery can use the DB safely)
# =============================================================================
_flask_app = None

def get_flask_app():
    """
    Lazily create the Flask app once for this worker process.
    """
    global _flask_app
...
def process_id_request(req_id: int):
    """
    Celery task: process one GameAccountRequest by ID.
    Runs ENTIRELY inside Flask app context so DB works on Celery worker.
    """
    app = get_flask_app()
